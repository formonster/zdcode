...
var arr2Dic = function(arr = [], field, other) {
  ...
  if (Array.isArray(field)) {
    arr.forEach((vo) => {
      dic[vo[field[0]]] = other ? Object.assign(vo, (0, import_lodash.clone)(other)) : vo[field[1]];
    });
  } else {
    arr.forEach((vo) => {
      dic[vo[field]] = other ? Object.assign(vo, (0, import_lodash.clone)(other)) : vo;
    });
  }
  return dic;
};
...
var flattenDeepByField = (arr, field) => {
  ...
  return (0, import_lodash.flattenDeep)(arr.map(map));
};
